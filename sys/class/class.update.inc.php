...
class update extends db_connect
{
    ...
    {
        $stmt = $this->db->prepare("ALTER TABLE users ADD level_create_at INT(10) UNSIGNED DEFAULT 0 after level");
        $stmt->execute();
    }
    ...
    {
        $stmt = $this->db->prepare("ALTER TABLE users ADD u_age INT(10) UNSIGNED DEFAULT 18 after sex");
        $stmt->execute();
    }
    ...
    {
        $stmt = $this->db->prepare("ALTER TABLE users ADD allowShowOnline SMALLINT(6) UNSIGNED DEFAULT 0 after allowShowMyAge");
        $stmt->execute();
    }
