...
<?php
    ...
    function draw($item)
    {
        ?>
            ...
            <tr class="data-item" data-id="<?php echo $item['chatId']; ?>">
                ...
                <td>
                    <a href="messages_b?chatId=<?php echo $item['chatId']; ?>" class="text-inverse" title="" data-toggle="tooltip" data-original-title="Open"><i class="ti-link"></i></a>
                </td>
            </tr>
