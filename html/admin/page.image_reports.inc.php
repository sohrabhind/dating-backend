        ...
        if (admin::getAccessToken() === $token && $admin_info['access_level'] < ADMIN_ACCESS_LEVEL_MODERATOR_RIGHTS) {
            ...
            switch ($act) {
                ...
                case "clear" : {
                    ...
                    header("Location: /admin/image_reports");
                    break;
                }
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                    ...
                    if ($inbox_loaded != 0) {
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <a href="/admin/image_reports?act=clear&access_token=<?php echo admin::getAccessToken(); ?>" style="float: right">
            ...
            Photo.remove = function (offset, fromUserId, accessToken) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/admin/image_remove?id=' + offset + '&fromUserId=' + fromUserId + '&access_token=' + accessToken,
...
<?php
    ...
    function draw($item)
    {
        $images = new gallery(null);
        $itemInfo = $images->info($item['itemId']);
        unset($images);
        ?>
