...
<head>
    ...
    <link href="/html/admin/css/bootstrap.css?x=1" rel="stylesheet">
...
<!--    <link href="/admin/css/c3.min.css" rel="stylesheet">-->
    ...
    <link href="/html/admin/css/style.css?x=4" rel="stylesheet">

    <link href="/html/admin/css/colors/blue.css" id="theme" rel="stylesheet">

    <?php
        foreach($css_files as $css): ?>
            <link rel="stylesheet" href="/html/admin/css/<?php echo $css."?x=6"; ?>" type="text/css" media="screen">
            <?php
        endforeach;
    ?>
