                ...
                if ($account_info['state'] == ACCOUNT_STATE_ENABLED) {
                    ...
                    if (!$result['error']) {
                        ...
                        if ($app_type == APP_TYPE_WEB) {
                            ...
                            auth::setSession($result['accountId'], $account_info['username'], $account_info['fullname'], $account_info['lowPhotoUrl'], $account_info['balance'], $account_info['pro'], $account_info['free_messages_count'], 0, $result['accessToken']);
